...
import {View, Platform, Text, Image, Dimensions, StyleSheet, DeviceInfo} from 'react-native';
    ...
    getParallaxRenderConfig(params) {
        ...
        config.renderFixedHeader = () => (
            <View key="fixed-header" style={styles.fixedSection}>
                {ViewUtils.getLeftBackButton(() => NavigationUtil.goBack(this.props.navigation))}
