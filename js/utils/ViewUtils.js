...
export default class ViewUtils {
    ...
    static getRightButton(title,callBack) {
        return <TouchableOpacity
            ...
            onPress={callBack}>
            <Text style={{fontSize: 20, color: 'white', marginRight: 10}}>{title}</Text>
        </TouchableOpacity>
    }
    ...
    static getMenuItem(callback, menu, color, expandableIco) {
        return ViewUtils.getSettingItem(callback, menu.name, color, menu.Icons, menu.icon, expandableIco);
    }
}
